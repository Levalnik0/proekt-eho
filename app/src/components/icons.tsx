...
/** Лупа — «Проверка сообщения» */
export function IconMagnifier({ size = 24, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      aria-hidden="true"
    >
      <circle cx="10.6" cy="10.6" r="6.6" stroke="currentColor" strokeWidth="2.2" />
      <path d="m15.6 15.6 4.4 4.4" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" />
      <path
        d="M10.6 7.6v3.6M10.6 13.6v.1"
        stroke="currentColor"
        strokeWidth="2.2"
        strokeLinecap="round"
      />
